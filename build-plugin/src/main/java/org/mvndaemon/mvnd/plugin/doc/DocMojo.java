...
public class DocMojo extends AbstractMojo {
  ...
  @Parameter(
      defaultValue = "org.mvndaemon.mvnd.common.Environment,org.mvndaemon.mvnd.common.OptionType")
  String[] enums;

  /**
   * If {@code true} the execution of this mojo will be skipped altogether; otherwise this mojo will
   * be executed.
   */
  ...
  static void extractEnumJavaDoc(Path basePath, String enumClassName) throws MojoFailureException {
    ...
    final Path enumClassLocation =
        basePath.resolve("src/main/java").resolve(classRelPath + ".java");
    final Path propsPath =
        basePath.resolve("target/classes/" + classRelPath + ".javadoc.properties");
    try {
