...
public class OsUtils {
  ...
  /**
   * Executes the given {@code javaExecutable} with {@code -XshowSettings:properties -version}
   * parameters and extracts the value of {@code java.home} from the output.
   *
   * @param javaExecutable pass {@code "java"} to get {@code java} binary available in {@code PATH}
   *     environment variable or pass an absolute path to a {@code "java"} executable
  ...
  /**
   * A simple wrapper over {@link Process} that manages its destroying and offers Java 8-like {@link
   * #waitFor(long)} with timeout.
   */
